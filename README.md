...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/KentaWood/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/KentaWood/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/KentaWood/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/KentaWood/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/KentaWood/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/KentaWood/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |          7m59.273s        |          0:18.45s         | 
| `pg_normalized_batch`  |          2m53.667s        |          0:08.95s         | 
| `pg_denormalized`      |          0m17.713s        |          0:03.96s         | 
